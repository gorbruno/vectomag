process MMSEQS_EASYTAXONOMY {
    ...
    output:
    tuple val(meta), val(meta2), val(meta3), path("${prefix}_lca.tsv")      , emit: lca
    tuple val(meta), val(meta2), val(meta3), path("${prefix}_report")       , emit: report
    tuple val(meta), val(meta2), val(meta3), path("${prefix}_tophit_aln")   , emit: tophit_aln
    tuple val(meta), val(meta2), val(meta3), path("${prefix}_tophit_report"), emit: tophit_report
